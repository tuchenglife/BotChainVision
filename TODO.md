...
| T-31 | 我的投資帳戶資料表 migration（holdings / realized / dividends） | S-07 | 高 |
| T-32 | 富邦/永豐/新光匯入 parser（CSV Big5/UTF-8、Excel openpyxl） | F-18, D-05 | 高 |
| T-33 | 我的帳戶 Streamlit 分頁：庫存、已實現、股利、月報 | F-18 | 高 |
| T-34 | 匯入資料驗證：券商總計 vs parser 加總 | F-18 | 高 |
